...
const Navbar = () => {
  return (
    <div className='bg-blue-950 py-1.5'>
      ...
      <div className='container mx-auto flex justify-around items-center'>
        ...
        <ul className='flex items-center gap-5 text-white'>
          ...
          <a href="/"><li className='w-25 px-1 border border-slate-400 bg-[#335C81] py-1 rounded-full flex justify-between items-center pr-2 '><img src="./Linkdin.png" className='rounded-full' width={32} alt="" />Linkdin</li></a>
         </ul>
      </div>
    </div>
  )
